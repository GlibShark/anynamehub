local function createUnsupportedMessage()
    ...
    messageFrame.Position = UDim2.new(0.5, -100, 0.85, 0) 
    ...
    warningText.Text = "Stable autofarm for you"
    ...
    game:GetService("TweenService"):Create(messageFrame, TweenInfo.new(0.5, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {Position = UDim2.new(0.5, -100, 0.85, 0)}):Play()
